...
/**
 * This function requires an own `window.os` property!
 */
export const nativeStorage: Storage = window.hasOwnProperty("os") ? window["nativeStorage"] : window["localStorage"];

export function setupNativeStorage() {}
